  ...
  export default {
    ...
    methods: {
      login() {
        ...
        // Exemple: this.$store.dispatch('login', { username: this.username, password: this.password })
      },
      forgotPassword() {
        // Ici, vous implémenterez la logique pour le mot de passe oublié
        console.log('Redirection vers la page de mot de passe oublié')
        // Exemple: this.$router.push('/forgot-password')
      }
    }
  }
  </script>
